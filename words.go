...
var comicname = []string{"井上泷奈", "锦木千束", "阿尼亚·福杰", "约尔·福杰", "后藤一里", "喜多川海梦",
	"三笠·阿克曼", "帕瓦", "露西", "斯莱塔·墨丘利", "钉崎野蔷薇", "栗花落香奈乎", "薇尔莉特", "艾露莎·舒卡勒托",
	"桔梗", "结城明日奈", "雪之下雪乃", "司波深雪", "时崎狂三", "赤瞳", "楪祈", "土间埋", "栗山未来", "加百列",
	"化野红绪", "爱蜜莉雅", "电次", "劳埃德·福杰", "早川秋", "工藤新一", "黑崎一护", "鸣人", "蜂乐回", "千切豹马",
	"诸星当", "影山茂夫", "铃木入间", "灵幻新隆", "朽木白哉", "希德·卡盖诺", "艾伦·耶格尔",
	"利威尔·阿克曼", "炭治郎", "绿谷出久", "五条悟", "虎杖悠仁", "伏黑惠"}

var genshinname = []string{"空", "荧", "派蒙", "琴", "凯亚", "安柏", "迪卢克", "芭芭拉", "菲谢尔", "雷泽", "温迪",
	"可莉", "行秋", "香菱", "重云", "七七", "莫娜", "诺艾尔", "丽莎", "甘雨", "胡桃", "烟绯", "申鹤", "阿贝多",
	"罗莎莉亚", "优菈", "雷电将军", "八重神子", "神里绫华", "神里绫人", "荒泷一斗", "托马", "九条裟罗", "珊瑚宫心海",
	"久岐忍", "流浪者", "纳西妲", "提纳里", "柯莱", "瑶瑶", "卡维", "绮良良", "莱欧斯利", "莱依拉", "那维莱特",
	"夏沃蕾", "芙宁娜", "夏洛蒂", "克洛琳德"}
...
var adjCount = len(adjwords)
var comicnameCount = len(comicname)
var genshinnameCount = len(genshinname)
